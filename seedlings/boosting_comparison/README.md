...
Head-to-head comparison of CatBoost, XGBoost, and LightGBM for binary
classification. Covers categorical feature handling, hyperparameter tuning,
threshold optimization, feature importance, SHAP explanations, and practical
...
├── plots/      # Saved figures
├── models/     # Trained model files (.cbm, .ubj, .lgb)
